  ...
  return (
    <main className="landing-page">
      ...
      <section className="landing-container subpage">
        <section className="subpage-hero"><div className="compliance-pill">Platform</div><h1>One workspace for ISO 27001 readiness.</h1><p>ComplyPilot helps your team manage controls, evidence, risks, tasks, and progress in one structured compliance platform.</p></section>
