  ...
  return (
    <main className="landing-page">
      ...
      <section className="landing-container subpage">
        <section className="subpage-hero"><div className="compliance-pill">Assessments</div><h1>Run structured ISO 27001 gap assessments.</h1><p>Identify missing controls, prioritize risks, and create a practical roadmap toward ISO 27001 readiness.</p></section>
