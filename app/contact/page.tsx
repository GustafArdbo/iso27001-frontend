  ...
  return (
    <main className="landing-page">
      ...
      <section className="landing-container subpage">
        <section className="subpage-hero"><div className="compliance-pill">Contact</div><h1>
            Talk to us about
            <br />
            ISO 27001 readiness.
        </h1><p>Tell us where you are in your ISO 27001 journey and we’ll help you identify the next practical step.</p></section>
